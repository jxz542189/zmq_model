...
import argparse
import sys
from zmq_server.server import BertServer


def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('-model_dir', type=str, default="/root/PycharmProjects/BERT-BiLSTM-CRF-NER/chinese_L-12_H-768_A-12",
